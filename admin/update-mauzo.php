...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM tbl_mauzo WHERE id=$id";
    ...
    <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                if($res3 == true)
                {
                    $_SESSION['update'] = "<div class='success'>Umefanikiwa Kusahihisha Mauzo.</div>";
                    header('location:'.SITEURL.'admin/manage-mauzo.php');
                }
                else
                {
                    $_SESSION['update'] = "<div class='error'>Imeshindikana kusahihisha Mauzo.</div>";
                    header('location:'.SITEURL.'admin/manage-mauzo.php');
                }
